...
As melhorias foram realizadas considerando as seguintes seis premissas:
...
│
├── limpo/
│   └── Código-fonte após aplicação dos princípios de Clean Code
│
├── relatorio/
...
Foram aplicadas práticas de formatação e padronização do código para melhorar sua organização e legibilidade.

### 2. Nomes legíveis

Variáveis, métodos, classes e outros elementos foram renomeados quando necessário, buscando utilizar nomes mais claros e representativos de suas responsabilidades.

### 3. Números mágicos

Valores numéricos utilizados diretamente no código foram analisados e, quando necessá
